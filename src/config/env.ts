...
export const appEnv = {
  ...
  clientName: rawEnv.VITE_CLIENT_NAME ?? 'Player',
  ...
  debugNetLogs: toBool(rawEnv.VITE_DEBUG_NET_LOGS, false),
  ...
  wakeGridCellSize: toNumber(rawEnv.VITE_WAKE_GRID_CELL_SIZE, 20),
}
