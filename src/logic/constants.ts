...
export const WAKE_MAX_SLOWDOWN = 0.4 // Max speed reduction
export const WAKE_LENGTH = 121 // Downwind wake length (scene units)
export const WAKE_HALF_WIDTH_START = 43 // Near-boat half width
export const WAKE_HALF_WIDTH_END = 7 // Wake narrows farther downwind
export const WAKE_WIDTH_CURVE = 1.7 // >1 narrows faster downwind
export const WAKE_LEEWARD_WIDTH_MULT = 0.1 // Leeward side width multiplier
export const WAKE_WINDWARD_WIDTH_MULT = 1.7 // Windward side width multiplier
export const WAKE_BIAS_DEG = -35 // Leeward bias away from pure downwind (unused)
export const WAKE_CORE_HALF_ANGLE_DEG = 11 // Core blanket width
export const WAKE_TURB_HALF_ANGLE_DEG = 13.5 // Turbulent zone width
export const WAKE_CORE_STRENGTH = 0.7 // Core blanket strength
export const WAKE_TURB_STRENGTH = 0.5 // Turbulent zone strength
export const WAKE_CORE_MAX_SLOWDOWN = 0.2 // Core blanket max slowdown
export const WAKE_TURB_MAX_SLOWDOWN = 0.25 // Turbulent zone max slowdown
export const WAKE_MIN_STRENGTH = 0.04 // Ignore negligible contributions
