...
export const WAKE_HALF_WIDTH_START = 29 // Near-boat half width
export const WAKE_HALF_WIDTH_END = 2 // Wake narrows farther downwind
export const WAKE_WIDTH_CURVE = 0.4 // >1 narrows faster downwind
export const WAKE_LEEWARD_WIDTH_MULT = 0.75 // Leeward side width multiplier
export const WAKE_WINDWARD_WIDTH_MULT = 1.55 // Windward side width multiplier
export const WAKE_BIAS_DEG = -35 // Leeward bias away from pure downwind
export const WAKE_TWA_ROTATION_SCALE_UPWIND = 0 // Rotation scale upwind
export const WAKE_TWA_ROTATION_SCALE_DOWNWIND = 0 // Rotation scale deep downwind
export const WAKE_CORE_HALF_ANGLE_DEG = 5.5 // Core blanket width
